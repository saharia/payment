...
Object.defineProperty(exports, "AuthMicroServiceGuard", {
    enumerable: true,
    get: function() {
        return AuthMicroServiceGuard;
    }
});
...
let AuthMicroServiceGuard = class AuthMicroServiceGuard extends (0, _passport.AuthGuard)([
    'jwtAuthMicroService'
]) {
    canActivate(context) {
...
AuthMicroServiceGuard = _ts_decorate([
