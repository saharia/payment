...
const _createpaymentgatewayinput = require("./create-payment-gateway.input");
...
let UpdatePaymentGatewayInput = class UpdatePaymentGatewayInput extends (0, _mappedtypes.PartialType)(_createpaymentgatewayinput.CreatePaymentGatewayInput) {
};
_ts_decorate([
...
UpdatePaymentGatewayInput = _ts_decorate([
