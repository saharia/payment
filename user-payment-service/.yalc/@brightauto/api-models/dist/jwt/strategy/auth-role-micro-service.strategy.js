...
exports.JwtAuthRoleMicroServiceStrategy = void 0;
...
let JwtAuthRoleMicroServiceStrategy = class JwtAuthRoleMicroServiceStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'jwtAuthRoleMicroService') {
    ...
    async validate(context, payload) {
        try {
            ...
            const roleAction = await (0, rxjs_1.lastValueFrom)(this.client.send('auth.findActionByRole', record));
            if (roleAction) {
                return context.user;
            }
            return false;
...
JwtAuthRoleMicroServiceStrategy = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [nat_service_1.NatService,
        config_1.ConfigService])
], JwtAuthRoleMicroServiceStrategy);
exports.JwtAuthRoleMicroServiceStrategy = JwtAuthRoleMicroServiceStrategy;
