...
exports.UpdatePaymentPlanInput = void 0;
...
const create_payment_plan_input_1 = require("./create-payment-plan.input");
let UpdatePaymentPlanInput = class UpdatePaymentPlanInput extends (0, mapped_types_1.PartialType)(create_payment_plan_input_1.CreatePaymentPlanInput) {
};
__decorate([
    (0, graphql_1.Field)(() => String),
    (0, class_validator_1.IsUUID)(4),
    (0, validation_1.RelationExists)(payment_plan_entity_1.PaymentPlan),
...
UpdatePaymentPlanInput = __decorate([
    (0, graphql_1.InputType)()
], UpdatePaymentPlanInput);
exports.UpdatePaymentPlanInput = UpdatePaymentPlanInput;
